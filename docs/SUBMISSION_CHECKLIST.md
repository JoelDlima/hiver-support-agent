...
| 2 | 6-page Virgin report (6 sections: framing/not-built, baselines weak+human, top-5 failures w/ real examples, misleading, next week incl. Groq, decisions pointer + Apple transfer row) | DONE | `docs/REPORT_VIRGIN_6PAGE.md` (human-200 headline: final 0.660/0.672, esc 0.580/0.784/0.667; Apple human-60/human-200 transfer rows; re-verified 2026-09-11) |
...
| 6 | Judge agreement + safety gate (heuristic offline; LLM hook gated wκ ≥0.60 + safety-recall ≥0.90; safety n=3 + money n=20 reported) | DONE (advisory-only, LLM unrun no-key) | `evaluation/virgin/JUDGE_AGREEMENT.md`, `evaluation/judge.py`, `evaluation/virgin/judge_scores_200.csv` |
| 7 | Failure tests (real pool probes, PASS/PARTIAL/FAIL verdicts + hypotheses H1–H7, no unsafe output) | DONE (7 PASS / 2 PARTIAL / 0 FAIL of 9 probes, exact-text re-probe 2026-09-11) | `evaluation/virgin/FAILURE_TESTS.md` (F1 delay, F2 21:03 + still-running fragility note, F3 lost+PII, F4 packed/overcrowd, F5 French, F6 refund, F7 lost-ticket) |
...
- Judge: report chance-corrected κ (esc-vs-human κ 0.577; weak-vs-human κ 0.772) + P/R + n + confusion source, never raw agreement alone; safety 1.000 (n=3) NOT a gate pass; money 0.800 (16/20) is the powered signal (Han 54-LLM r=0.95/κ=0.45 trap; Judge's Verdict human κ̄ 0.801 reference).
