...
Repo: `C:\Hiver` (also see `docs/DECISION_LOG.md`). Borrowed: sklearn/pandas/FastAPI/pytest, TWCS (CC BY-NC-SA 4.0), Banking77 (CC-BY-4.0, intent design only), cited in README + research log.
