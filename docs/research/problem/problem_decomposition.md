...
4. **Proves trust** — ships with frozen `golden_v1` (150–250 labels), reproducible eval harness, pinned baselines, failure/adversarial suite, and a report that discloses what the headline numbers do NOT prove (see Agent 9 `docs/research/evaluation/eval_strategy.md` — this doc is the problem-side companion, not a duplicate).
