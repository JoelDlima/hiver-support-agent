---
title: BERTopic — BERTopic latest documentation
id: bertopic-bertopic-latest-documentation
tags:
- hiver-support-agent-audit-6d951f
created: '2026-09-15T02:28:35.994732Z'
source: https://bertopic.readthedocs.io/en/latest/index.html
source_domain: bertopic.readthedocs.io
fetched_at: '2026-09-15T02:28:35.992404Z'
...
Installation
¶
Installation, with sentence-transformers, can be done using
pypi
:
pip
install
...
¶
In BERTopic, there are a number of different
topic representations
that we can choose from. They are all quite different from one another and give interesting perspectives and variations of topic representations. A great start is
KeyBERTInspired
...
Instead of iterating over all of these different topic representations, you can model them simultaneously with
...
of embeddings
Clustering
reduced embeddings into topics
Tokenization
of topics
Weight
tokens
...
multiple
representations
To find more about the underlying algorithm and assumptions
here
.
Overview
¶
...
refer to how model information is stored on an estimator during fitting. The attributes that you see below all end in
_
and are
...
| The top
n
terms per topic and their respective c-TF-IDF values.                           |
|
.c_tf_idf_
| The topic-term matrix as calculated through c-TF-IDF.                                       |
|
.topic_aspects_
| The different aspects, or representations, of each topic.                                  |
|
.topic_labels_
...
|———————–|—|
|
Topic Distribution Approximation
|
.approximate_distribution(docs)
|
|
...
|
.topics_per_class(docs,
classes)
|
|
Dynamic Topic Modeling
|
.topics_over_time(docs,
timestamps)
|
|
Hierarchical Topic Modeling
|
.hierarchical_topics(docs)
|
|
...
.get_topic_tree(hierarchical_topics)
|
...
.visualize_distribution(probs[0])
|
| Visualize Topics over Time   |
.visualize_topics_over_time(topics_over_time)
|
