...
**What we do (`evaluation/BASELINE_VS_FINAL.md`, `docs/research/evaluation/eval_strategy.md` §9, `docs/DIFFERENTIATION.md`):**
...
*Local artifacts audited:* `evaluation/{GOLDEN_NOTE,BASELINE_VS_FINAL,PER_INTENT,confusion_human60,JUDGE_AGREEMENT,JUDGE_AGREEMENT_V2,ABLATION,RETRIEVAL_METRICS,PERFORMANCE,COST,FAILURE_TESTS,rubric,judge}.md/py/csv` · `docs/research/{competitors/analysis,evaluation/eval_strategy,papers/academic_review}.md` · `docs/DIFFERENTIATION.md` (V1).
