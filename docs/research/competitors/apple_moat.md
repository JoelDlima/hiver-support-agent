...
**Project:** Hiver @ `.` — AppleSupport Twitter agent (classify 11 intents → grounded draft → escalate)
...
*Write: `docs/research/competitors/apple_moat.md` (this file). Next: wire §4 table into eval stratum + §6 reason codes into failure suite F1–F8.*
