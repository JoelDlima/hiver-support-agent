...
Scope: `src/`, `backend/`, `scripts/`, `configs/` inside `.`. Method: pattern grep + `scripts/smoke_fail.py` + API probes.
...
- `pytest tests -q`: **10 passed** (4 existing + 6 new `test_reliability.py`).
