...
- Money: 20 human money_threshold cases, system escalate recall=0.850.
- Escalation vs human: acc=0.915 kappa=0.715 P=0.778 R=0.757 F1=0.767
- Groundedness: mean=4.32, >=4 rate=1.000, PASS=1.000 (heuristic, template-shaped — circular by design)
