...
Date: 2026-09-11. Context: VirginTrains niche, FastAPI + SQLite/joblib file indexes (27,172 Virgin docs, p50 ~7ms), Docker (`deployment/Dockerfile.simple`). 20 websearch queries, full DATE/QUERY/SOURCE/FINDING/RELEVANCE/IMPACT ledger in `research/research_log.md` (2026-09-11 Breadth: platforms + infra entry). All writes inside `C:\Hiver` only.
